...
from src.pipelines import main, predict
...
def test_inv(text_a, text_b, tag, artifacts):
    ...
    tag_a = predict.predict(texts=[text_a], artifacts=artifacts)[0][
        "predicted_tag"
    ]
    tag_b = predict.predict(texts=[text_b], artifacts=artifacts)[0][
        "predicted_tag"
    ]
